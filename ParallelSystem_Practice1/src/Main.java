...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 10; i <= 100000; i = i * 10) {
            ...
            sequentialFunction(createStartVector(i), 5, taskValue);
    ...
    public static void sequentialFunction(double[] startVector, int C, int taskValue) {
        int K = 100;
