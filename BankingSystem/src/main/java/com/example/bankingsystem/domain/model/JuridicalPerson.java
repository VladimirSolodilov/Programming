...
public class JuridicalPerson {
    ...
    public JuridicalPerson(int juridicalPersonId, int branchId, int roleId, String surname, String name, String patronymic, String juridicalPersonName, String password, int sum) {
